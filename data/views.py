...
def delete_staff(request,id):
    staff = Staff.objects.get(pk=id).delete()
    return redirect('staff')
...
def delete_visit(request,id):
    visit = PatientVisit.objects.get(pk=id).delete()
    return redirect('visits')
...
def delete_drugs(request,id):
    drugs = Drug.objects.get(pk=id).delete()
    return redirect('drugs')
...
def delete_supplier(request,id):
    supplier = Supplier.objects.get(pk=id).delete()
    return redirect('suppliers')
...
def delete_appointment(request,id):
    appointments = Appointment.objects.get(pk=id).delete()
    return redirect('appointments')
...
def delete_prescription(request,id):
    prescription = Prescription.objects.get(pk=id).delete()
    return redirect('prescriptions')

##HEALTH HISTORY RELATED
...
def delete_health_history(request,id):
    historyForm = HistoryForm.objects.get(pk=id).delete()
    return redirect('health_histories')
...
def delete_bill(request,id):
    bills = PatientBill.objects.get(pk=id).delete()
    return redirect('bills')
...
def delete_feedback(request,id):
    feedback = PatientFeedback.objects.get(pk=id).delete()
    return redirect('feedbacks')
